...
def fetch_oann(url: str, *, timeout_s: float = 10.0) -> str:
    """
...
if __name__ == "__main__":
    print(
        fetch_oann(
            "https://www.oann.com/newsroom/michael-cohen-i-felt-pressured-and-coerced-by-letitia-james-and-alvin-bragg-to-testify-against-trump/"
        )
    )
